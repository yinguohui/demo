package com.antiy.demo.nio.nio;
...
public class NioSocketServer {
    public static void main(String[] args) throws IOException {
        ...
        // 得到监听端口实例
        ServerSocket socketChannel = channel.socket();
        ServerSocket serverSocket1 = channel2.socket();
        // 绑定监听的端口
        socketChannel.bind(new InetSocketAddress(8083));
        serverSocket1.bind(new InetSocketAddress(8084));
        // 创建选择器
        ...
        try {
            while (true) {
                ...
                if (selector.select(1000) == 0) {
                    System.out.println("监听1000毫秒没有感兴趣的事" + System.currentTimeMillis());
                    continue;
                }
